...
public class Orcamento {
    ...
    public Orcamento(Long codOrcamento, Long codCliente, Date dataEmissao, Date previsaoEntrega, List listaProdutos, List listaServicos, double valorTotal, boolean status) {
